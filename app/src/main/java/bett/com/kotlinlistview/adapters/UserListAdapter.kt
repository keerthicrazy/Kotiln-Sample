...
import bett.com.kotlinlistview.MainActivity
 ...
 */
class UserListAdapter(private var activity: Activity, private var items: ArrayList<UserDto>, itemClickListners: onItemClickListener): BaseAdapter() {
//    var items = ArrayList<UserDto>()
//    var activity: Activity? = null
        var itemClickListners:onItemClickListener ?= null
    init {
